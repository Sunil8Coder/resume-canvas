      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Create stunning, professional resumes and biodata completely free. No hidden fees, no watermarks — just
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Resume4J is a product of <span className="font-semibold gradient-text">Scriptimiz Insight LLP</span>. We
              believe everyone deserves access to professional resume tools — completely free.
            </p>
            <a
              href="https://resume4j.scriptimiz.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 text-sm text-primary hover:text-primary/80 transition-colors"
            >
              resume4j.scriptimiz.com
        ...
        <div className="border-t border-border/20 pt-6">
          <div className="flex flex-col items-center justify-center gap-2 text-center">
            <p className="text-xs text-muted-foreground">© {currentYear} Resume4J. All rights reserved.</p>
